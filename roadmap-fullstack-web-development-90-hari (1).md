...
- 🤖 **Baru**: roadmap ini sekarang menyertakan aturan penggunaan AI per fase (lihat bagian "Panduan Menggunakan AI" di bawah) — dibaca dulu sebelum mulai Hari 1.
...
## 🤖 Panduan Menggunakan AI Sebagai Learning Partner (Bukan Contekan)

### Prinsip Dasar
AI (Claude, ChatGPT, GitHub Copilot, Cursor, dll) adalah **akselerator**, bukan **pengganti** proses belajar. Aturan emasnya:

> **Struggle dulu minimal 20-30 menit sendiri sebelum tanya AI.** Kalau langsung tanya AI begitu stuck, otak Anda tidak sempat membentuk koneksi yang membuat skill itu benar-benar "nempel".

Kenapa ini penting: banyak orang belajar coding dengan bantuan AI merasa progress cepat di awal, tapi kolaps saat masuk fase backend/fullstack karena fondasinya cuma "familiar", bukan benar-benar dikuasai. AI tidak mengubah kebutuhan fondasi — AI mengubah *efisiensi* Anda setelah fondasi itu ada.

### Aturan Pakai AI per Fase

| Fase | Boleh pakai AI untuk | JANGAN pakai AI untuk |
|---|---|---|
| **1-2** (Fondasi HTML/CSS/JS, Git) | Minta penjelasan konsep dengan analogi lain kalau sumber belajar utama masih membingungkan; cek pemahaman ("saya jelaskan closure begini, betul nggak?"); debug error message **setelah** dicoba sendiri 20-30 menit | Generate kode latihan/project dari nol; menyelesaikan tugas latihan untuk Anda |
| **3-4** (React, Backend) | Review kode yang **sudah Anda tulis sendiri**; tanya "kenapa pattern ini lebih baik dari itu"; jadi rubber duck saat debug; riset dokumentasi library baru | Generate seluruh komponen/fitur langsung dari prompt tanpa Anda coba dulu; accept kode AI tanpa paham tiap barisnya |
| **5-6** (Fullstack, Deployment, Advanced) | Pair programming penuh — scaffolding, boilerplate, debug masalah kompleks, riset teknologi baru, code review menyeluruh. Fase ini paling wajar pakai AI coding assistant (Claude Code, Cursor, Copilot) seperti developer profesional beneran | Commit kode yang Anda sendiri tidak bisa jelaskan kalau ditanya saat interview |

### Prompt Template yang Berguna
- **Untuk belajar konsep** (Fase 1-2): *"Saya masih pemula, jelaskan [konsep] pakai analogi sehari-hari. Jangan kasih kode dulu, saya mau coba sendiri setelah paham konsepnya."*
- **Untuk review kode** (Fase 3+): *"Ini kode saya: [paste]. Jangan tulis ulang, tapi kasih tahu apa yang bisa lebih baik dan kenapa."*
- **Untuk debug** (semua fase): *"Saya dapat error ini: [error]. Ini kode saya: [paste]. Saya sudah coba [apa yang sudah dicoba]. Kasih hint dulu, jangan langsung solusi lengkap."*
- **Untuk validasi pemahaman**: *"Saya akan jelaskan cara kerja [topik] pakai bahasa saya sendiri, koreksi kalau ada yang salah: ..."*

### Skill Baru yang Perlu Ditambahkan: "AI-Assisted Development"
Ini sekarang adalah skill industri yang nyata, bukan sekadar bonus. Tambahkan ke **Fase 6 (Hari 83-87)** sebagai topik advanced tambahan:
- Prompt engineering untuk coding (spesifik, kasih konteks/constraint, minta AI tanya balik kalau requirement ambigu)
- Cara membaca & mengevaluasi kode AI-generated secara kritis (bukan blind-accept)
- Kapan pakai AI agentic tools (seperti Claude Code) vs kapan lebih baik menulis manual
- Code review checklist khusus untuk kode hasil AI (cek security, edge case, konsistensi dengan codebase)

### Dampak ke Timeline
Timeline 60-90 hari **tidak dipangkas**, karena Fase 1-2 tetap butuh repetisi manual tanpa bantuan AI supaya fondasi kuat. Tapi efeknya terasa di Fase 3 ke atas: debugging dan riset jadi jauh lebih cepat dengan AI, jadi waktu yang biasanya habis untuk "stuck cari solusi di Google 2 jam" bisa dialihkan untuk memperdalam pemahaman atau menambah fitur project. Anggap AI sebagai **buffer waktu ekstra**, bukan alasan mempercepat jadwal.

### ⚠️ Tanda Bahaya: Anda Terlalu Bergantung ke AI
- Tidak bisa menjelaskan kode di project Anda sendiri tanpa membuka chat AI
- Selalu minta AI generate dulu sebelum coba sendiri, bahkan untuk hal sederhana
- Merasa panik/blank saat coding tanpa akses internet/AI
- Kalau Anda mengenali tanda-tanda ini di diri sendiri, **kembali ke Checkpoint terakhir** dan ulangi tanpa AI sampai benar-benar lolos.
